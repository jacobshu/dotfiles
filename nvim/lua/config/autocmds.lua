...
vim.api.nvim_create_autocmd("LspAttach", {
    ...
    callback = function(event)
        ...
        map("<leader>V", "<cmd>vsplit | lua vim.lsp.buf.declaration()<cr>", "Goto Declaration in Vertical Split")
        ...
        wk.add({
            ...
            { "<leader>lr", vim.lsp.buf.references,                            desc = "Display References"
            { "<leader>lR", vim.lsp.buf.rename,                                desc = "Rename all references" },
            { "<leader>lf", vim.lsp.buf.format,                                desc = "Format" },
            { "<leader>le", vim.lsp.buf.hover,
